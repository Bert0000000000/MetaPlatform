...
def test_lightrag_httpx_query_calls_api(respx_mock):
    ...
    respx_mock.get("http://localhost:9621/health").mock(
        ...
        return_value=respx.MockResponse(
            ...
            json={
                "chunks": [
                    ...
                    {"id": "c2", "content": "second", "score": 0.7},
                ]
            },
        )
    )
