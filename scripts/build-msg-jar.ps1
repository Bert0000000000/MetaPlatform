...
& 'C:\Program Files\Java\apache-maven-3.9.16\bin\mvn.cmd' install:install-file '-Dfile=target\tech-msg-classes.jar' '-DgroupId=com.metaplatform' '-DartifactId=tech-msg' '-Dversion=0.0.1-SNAPSHOT' '-Dpackaging=jar' 2>&1 | Select-String -Pattern 'BUILD' | Select-Object -First 3
