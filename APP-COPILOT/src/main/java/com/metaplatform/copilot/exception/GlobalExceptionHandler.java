package com.metaplatform.copilot.exception;

import com.metaplatform.copilot.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleArg(IllegalArgumentException ex) {
        return ResponseEntity.badRequest().body(new ErrorResponse("INVALID_ARG", ex.getMessage()));
    }
