...
def _seed_plans(tenant_id: str) -> dict[str, Plan]:
    rows = [
        ...
        (
            "plan-2",
            "Customer onboarding",
            "Streamline new account setup",
            ("Verify identity", "Create workspace", "Send welcome"),
        ),
        (
            "plan-3",
            "Incident response",
            "Triage and resolve P1 incidents",
            ("Classify severity", "Assign owner", "Escalate"),
        ),
        (
            "plan-4",
            "Campaign launch",
            "Coordinate multi-channel rollout",
...
def _seed_intents(tenant_id: str) -> dict[str, Intent]:
    ...
    return {
        rid: Intent(id=rid, tenant_id=tenant_id, name=name, keywords=kw) for rid, name, kw in rows
    }
...
def _seed_actions(tenant_id: str) -> dict[str, Action]:
    ...
    rows = [
        ...
        (
            ...
            (
                ...
                },
                {
                    ...
                    "type": "string",
                    "required": True,
                    "defaultValue": "ont.tenant-default.ind.leave-request.1",
        ...
        (
            ...
            (
                ...
                },
                {
                    ...
                    "type": "string",
                    "required": True,
                    "defaultValue": "ont.tenant-default.ind.ticket.1",
        ...
        (
            "act-onboard-employee",
            "Onboard Employee",
            "Provision a new employee account",
            "hr",
            ("onboard", "provision", "setup"),
            (),
        ),
    ]
    return {
