    ...
    r.upsert_action_type(
        ActionType(
            ...
            parameters=(
                ...
                Property(
                    rid=ClassRef(f"ont.{T}.prop.score.v1"),
                    type_id="integer",
                    nullable=True,
                    primary_key=False,
                    title="score",
...
class TestReferencedParameterValidation:
    ...
    def test_type_mismatch(self) -> None:
        ...
        v = validate_referenced_parameters(at.parameters, {"score": "not-a-number"}, templates)
    ...
    def test_unreferenced_required_not_demanded(self) -> None:
        ...
        at = r.get_action_type(ClassRef(ACT))
        templates = [
            {"op": "set_property", "target": "$target", "property_rid": P_SEV, "value": "high"}
        ]  # 不引用任何参数
...
PG_DSN = os.environ.get("ACT0607_PG_DSN", "postgresql://meta:meta@127.0.0.1:5432/metaplatform_ont")
