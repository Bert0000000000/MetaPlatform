...
class TestCheckpointRuns:
    def test_checkpoint_runs_and_returns_status(self, client: InMemoryQualityClient) -> None:
        suite = _suite()
...
class TestSuiteRegistration:
    def test_suite_registered_before_run(self, client: InMemoryQualityClient) -> None:
...
class TestTenantIsolation:
    def test_tenant_isolation(self, client: InMemoryQualityClient) -> None:
...
class TestBlockingSemantics:
    def test_critical_check_blocks_on_failure(self, client: InMemoryQualityClient) -> None:
    ...
    def test_non_blocking_check_passes_on_failure(self, client: InMemoryQualityClient) -> None:
    ...
    def test_skipped_when_no_checks(self, client: InMemoryQualityClient) -> None:
...
class TestRunIdUniqueness:
    def test_run_id_unique_per_run(self, client: InMemoryQualityClient) -> None:
        suite = _suite()
        client.register_suite(suite)
...
class TestResultsCarryTenantId:
    def test_results_carry_tenant_id(self, client: InMemoryQualityClient) -> None:
        suite = _suite(tenant_id="tenant-acme")
        client.register_suite(suite)
        cp = client.run_checkpoint("tenant-acme", "iam.user.tenant_notnull")
...
class TestListSuitesByDomain:
    def test_list_suites_filtered_by_domain(self, client: InMemoryQualityClient) -> None:
...
class TestCheckpointHistory:
    def test_checkpoint_history_per_suite(self, client: InMemoryQualityClient) -> None:
        suite = _suite()
        client.register_suite(suite)
        for _ in range(3):
            client.run_checkpoint("tenant-acme", "iam.user.tenant_notnull")

        history = client.checkpoint_history("tenant-acme", "iam.user.tenant_notnull")
    ...
    def test_history_empty_for_unrun_suite(self, client: InMemoryQualityClient) -> None:
        suite = _suite()
        client.register_suite(suite)
        history = client.checkpoint_history("tenant-acme", "iam.user.tenant_notnull")
        assert history == []

    def test_history_isolated_per_tenant(self, client: InMemoryQualityClient) -> None:
        client.register_suite(_suite(tenant_id="tenant-acme"))
        client.register_suite(_suite(tenant_id="tenant-globex", name="iam.user.tenant_notnull"))
        client.run_checkpoint("tenant-acme", "iam.user.tenant_notnull")
        client.run_checkpoint("tenant-globex", "iam.user.tenant_notnull")

        acme_hist = client.checkpoint_history("tenant-acme", "iam.user.tenant_notnull")
        globex_hist = client.checkpoint_history("tenant-globex", "iam.user.tenant_notnull")
...
class TestInvalidSuiteRejected:
    def test_invalid_suite_empty_name(self, client: InMemoryQualityClient) -> None:
    ...
    def test_invalid_suite_empty_tenant(self, client: InMemoryQualityClient) -> None:
        bad = ExpectationSuite(
            name="some.suite",
            tenant_id="",
        )
