...
CONFIG_SEED: list[ConfigSpec] = [
    ...
    {
        "key": "ai.provider.openai.enabled",
        "value": "false",
        "value_type": "bool",
    ...
    {
        "key": "ai.provider.openai.base_url",
        "value": "https://api.openai.com/v1",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "OpenAI Base URL",
        "description": "兼容 OpenAI 协议的服务地址（如 https://api.openai.com/v1、Azure 自定义域、自建代理）",
    },
    {
        "key": "ai.provider.openai.api_key",
        "value": "",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
    ...
    {
        "key": "ai.provider.openai.default_model",
        "value": "gpt-4o-mini",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "OpenAI 默认模型",
    ...
    {
        "key": "ai.provider.azure.enabled",
        "value": "false",
        "value_type": "bool",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "Azure OpenAI 启用",
    },
    {
        "key": "ai.provider.azure.base_url",
        "value": "https://{your-resource}.openai.azure.com/openai/deployments",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "Azure OpenAI Base URL",
        "description": "Azure OpenAI 部署端点",
    },
    {
        "key": "ai.provider.azure.api_key",
        "value": "",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
    ...
    {
        "key": "ai.provider.azure.api_version",
        "value": "2024-02-01",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
    ...
    {
        "key": "ai.provider.ollama.enabled",
        "value": "false",
        "value_type": "bool",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "Ollama 提供方启用",
        "description": "用于本地/自托管模型（http://host:11434）",
    },
    {
        "key": "ai.provider.ollama.base_url",
    ...
    {
        "key": "ai.provider.ollama.default_model",
        "value": "llama3.2",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "Ollama 默认模型",
    ...
    {
        "key": "ai.provider.custom.enabled",
        "value": "false",
        "value_type": "bool",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "自定义第三方模型启用",
        "description": "对接其他 OpenAI 兼容 API（如智谱 GLM、DeepSeek、自建网关）",
    },
    {
        "key": "ai.provider.custom.base_url",
        "value": "",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "自定义 Base URL",
    ...
    {
        "key": "ai.provider.custom.api_key",
        "value": "",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "自定义 API Key",
    ...
    {
        "key": "ai.provider.custom.default_model",
        "value": "",
        "value_type": "string",
        "category": ConfigCategory.AI_PROVIDER,
        "label": "自定义默认模型",
