...
async def main() -> int:
    ...
    try:
        for ddl in (
            "DROP TABLE IF EXISTS ont_relations", "DROP TABLE IF EXISTS ont_instances",
            "DROP TABLE IF EXISTS ont_classes", "DROP TABLE IF EXISTS ont_ontologies",
        ):
        ...
        for t, want in (("ont_classes", 2), ("ont_instances", 3),
                        ("ont_relations", 1)):
