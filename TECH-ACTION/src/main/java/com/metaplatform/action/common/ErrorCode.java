...
public enum ErrorCode {
    ...
    MISSING_REQUIRED_FIELD(40003, HttpStatus.BAD_REQUEST, "必填字段缺失"),
    ...
    EXECUTION_NOT_FOUND(40406, HttpStatus.NOT_FOUND, "执行记录不存在"),
    ...
    EXECUTION_ALREADY_FINISHED(40904, HttpStatus.CONFLICT, "执行已结束，不可中止"),
    ...
    EXECUTION_CANNOT_RETRY(42204, HttpStatus.UNPROCESSABLE_ENTITY, "执行状态不允许重试"),
