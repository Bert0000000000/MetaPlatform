...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+asyncpg://meta:meta@localhost:5432/metaplatform_agent"
    ...
    action_base_url: str = "http://localhost:8104"
    action_timeout: float = 30.0

    # TECH-RAG base URL. Empty string enables mock mode.
    rag_base_url: str = "http://localhost:8901"
