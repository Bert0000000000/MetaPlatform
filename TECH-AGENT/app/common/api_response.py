"""Unified API response envelope used by all TECH-AGENT endpoints."""
...
def fail(
    ...
    *,
    ...
    """Build an error response payload. HTTP status is applied by the global
    exception handler; this helper only shapes the body."""
