...
import type { UserSettings, ThemeMode } from '@/api/dashboard/types';
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { getSettings } = await import('@/api/dashboard/settings');
  ...
  const updateSettings = useCallback(async (patch: Partial<UserSettings>) => {
    ...
    const { updateSettings: remoteUpdate } = await import('@/api/dashboard/settings');
