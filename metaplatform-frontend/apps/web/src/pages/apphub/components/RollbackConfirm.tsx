    ...
    <Banner
      ...
      title={
        <Typography.Text>
          ...
          <strong style={{ color: 'var(--semi-color-danger)' }}>v{target.version}</strong>？
        </Typography.Text>
      }
      description={
        <div>
          ...
          <div style={{ marginTop: 8, color: 'var(--semi-color-warning)', display: 'flex', alignItems: 'center', gap: 6 }}>
