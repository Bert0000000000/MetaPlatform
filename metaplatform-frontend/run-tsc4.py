...
os.makedirs(
    r"D:\\Hermes\\Workspace\\10_Projects\\2026-07-02-MetaPlatform\\metaplatform-frontend\\tsc-logs",
    exist_ok=True,
)
...
r = subprocess.Popen(
    "cmd /c "
    + chr(34)
    + r"D:\\Hermes\\Workspace\\10_Projects\\2026-07-02-MetaPlatform\\metaplatform-frontend\\node_modules\\.bin\\tsc.cmd -p D:\\Hermes\\Workspace\\10_Projects\\2026-07-02-MetaPlatform\\metaplatform-frontend\\apps\\web\\tsconfig.json --noEmit --skipLibCheck --incremental false > "
    + out_path
    + " 2> "
    + err_path
    + chr(34),
