...
const NODE_LIBRARY: { category: string; items: { id: string; name: string; icon: LucideIcon; color: string }[] }[] = [
  { category: "事件 (Events)", items: [
    ...
    { id: "intermediate", name: "中间事件", icon: Circle, color: "bg-primary" },
    { id: "timer", name: "定时事件", icon: Clock, color: "bg-primary" },
    ...
    { id: "escalation", name: "升级事件", icon: ArrowUp, color: "bg-primary" },
    { id: "compensate", name: "补偿事件", icon: RotateCcw, color: "bg-primary" },
  ]},
  { category: "活动 (Activities)", items: [
    ...
    { id: "manual-task", name: "手工任务", icon: Hand, color: "bg-primary" },
    { id: "business-rule", name: "业务规则", icon: Ruler, color: "bg-primary" },
    { id: "send-task", name: "发送任务", icon: Send, color: "bg-primary" },
    { id: "receive-task", name: "接收任务", icon: Download, color: "bg-primary" },
  ]},
  ...
  { category: "网关 (Gateways)", items: [
    { id: "exclusive", name: "排他网关", icon: X, color: "bg-primary" },
    { id: "parallel", name: "并行网关", icon: Plus, color: "bg-blue-500" },
    { id: "inclusive", name: "包容网关", icon: Circle, color: "bg-primary" },
    { id: "event-based", name: "事件网关", icon: Diamond, color: "bg-primary" },
