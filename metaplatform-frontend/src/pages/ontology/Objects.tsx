...
import { Plus, Sparkles, Search, Edit, Trash2, Link2 } from "lucide-react";
...
export default function Objects() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">所有对象（{filtered.length}）</CardTitle>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              {filtered.map((obj) => (
                <TableRow key={obj.id}>
                  <TableCell>{(() => { const Icon = obj.icon; return <Icon className="size-5" />; })()}</TableCell>
