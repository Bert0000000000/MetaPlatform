...
export const MENU_TABS: Record<MenuKey, TabConfig[]> = {
  ...
  ontology: [
    ...
    { key: "properties", label: "属性", path: "/ontology/properties" },
    { key: "links", label: "关系", path: "/ontology/links" },
    { key: "actions", label: "动作", path: "/ontology/actions" },
    { key: "functions", label: "函数", path: "/ontology/functions" },
    { key: "rules", label: "流程规则", path: "/ontology/rules" },
    { key: "orchestration", label: "业务流程编排", path: "/ontology/orchestration" },
    { key: "security", label: "安全", path: "/ontology/security" },
    { key: "governance", label: "治理与发布", path: "/ontology/governance" },
  ],
  quality: [
