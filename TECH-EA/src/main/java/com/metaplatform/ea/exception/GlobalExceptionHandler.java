...
import com.metaplatform.ea.common.TraceContext;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EaException.class)
    public ResponseEntity<ApiResponse<Void>> handleEaException(EaException e) {
