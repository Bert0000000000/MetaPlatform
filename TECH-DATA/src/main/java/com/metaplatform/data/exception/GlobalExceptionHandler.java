...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDataException(DataException ex, HttpServletRequest request) {
        ...
        log.warn("业务异常 | path={} code={} msg={}", request.getRequestURI(), code.getCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleNoResourceFound(NoResourceFoundException ex) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ApiResponse.error(ErrorCode.DATASOURCE_NOT_FOUND, "资源不存在: " + ex.getResourcePath()));
    }
