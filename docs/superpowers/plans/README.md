...
## 第 2 期 · MVP（月 T0 ~ T+6m）— Spike 验收通过，开始执行

| Plan 文件 | 子项目 | 状态 | 预计工时 |
|---|---|---|---|
| [`2026-07-02-platform-base-v0.1.md`](./2026-07-02-platform-base-v0.1.md) | **子项目 6：平台底座 v0.1** | ✅ Plan 已产出，待执行 | 12 Tasks ~16 天 |
| [`2026-07-02-ai-substrate-v0.1.md`](./2026-07-02-ai-substrate-v0.1.md) | **子项目 3：AI Substrate v0.1** | ✅ Plan 已产出，待执行 | 13 Tasks ~18 天 |
| [`2026-07-02-business-object-v0.1.md`](./2026-07-02-business-object-v0.1.md) | **子项目 2：业务对象层 v0.1** | ✅ Plan 已产出，待执行 | 13 Tasks ~16 天 |
| `2027-01-02-page-form-generator-v0.1.md`（待产出） | 子项目 4：页面/表单生成器 v0.1 | 🟡 待子项目 2 完成后开始 | |
| `2027-01-02-process-automation-v0.1.md`（待产出） | 子项目 5：流程自动化 v0.1 | 🟡 待子项目 2 完成后开始 | |
| `2027-01-02-rag-mdm-v0.1.md`（待产出）| 子项目 7：RAG/非结构/MDM v0.1 | 🟡 待子项目 3 完成后开始 | |
| `2027-01-02-dialogue-v0.1.md`（待产出）| 子项目 8：对话层 v0.1 | 🟡 待子项目 2+3 完成后开始 | |
| `2027-01-02-capability-library-v0.1.md`（待产出）| 子项目 9：能力库 v0.1 | 🟡 待子项目 5 完成后开始 | |

### MVP 执行顺序（基于依赖关系）

```
第 1 批（并行）：平台底座(6) + AI Substrate(3)
    ↓
第 2 批：业务对象层(2) ← 依赖平台底座(6)
    ↓
第 3 批（并行）：页面生成器(4) + 流程自动化(5) + RAG/MDM(7)
    ↓
第 4 批：对话层(8) + 能力库(9)
```
