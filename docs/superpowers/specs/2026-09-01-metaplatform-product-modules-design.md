...
flowchart TB
  ...
  N006["任务与运行中心"]
  N001 --> N006
  N007["Session 与 WorkItem"]
  N006 --> N007
  N008["Run 与 SubRun"]
  N006 --> N008
  N009["HostSession 与 Lease"]
  N006 --> N009
  N010["产物与审批中心"]
  N001 --> N010
  N011["Artifact Schema"]
  N010 --> N011
  N012["报告与证据"]
  N010 --> N012
  N013["ActionPlan 与审批"]
  N010 --> N013
  N014["Decision 与 Receipt"]
  N010 --> N014
  N015["智能生产面"]
  ROOT --> N015
  N016["应用中心"]
...
flowchart TB
  ...
  N027["撤回过期"]
  N023 --> N027
  N028["记录 DecisionRecord"]
  N023 --> N028
  N029["执行回执"]
  ROOT --> N029
  N030["创建 ExecutionReceipt"]
  N029 --> N030
  N031["查询副作用对账"]
  N029 --> N031
  N032["追加补偿回执"]
...
flowchart TB
  ...
  N010["删除草稿废弃发布项"]
  N006 --> N010
  N011["Link 与语义 Action"]
  ROOT --> N011
  N012["新增关系动作"]
  N011 --> N012
  N013["查询 Domain Range 绑定"]
  N011 --> N013
  N014["修改约束效果"]
  N011 --> N014
  N015["停用替代"]
...
flowchart TB
  ...
  N032["服务主体与身份联合"]
  ROOT --> N032
  N033["新增 Principal IdentityLink"]
  N032 --> N033
  N034["查询凭据会话"]
  N032 --> N034
  N035["轮换修改"]
...
flowchart TB
  ...
  N027["字典与模板"]
  ROOT --> N027
  N028["新增 Dictionary Notification"]
  N027 --> N028
  N029["查询版本本地化"]
  N027 --> N029
  N030["修改草稿"]
