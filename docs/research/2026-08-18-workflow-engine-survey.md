...
> _"FlowGram is a composable, visual, easy-to-integrate, and extensible workflow development **framework & toolkit**. … It's **not a ready-made workflow platform**; it's the framework and toolkit to build yours."_
