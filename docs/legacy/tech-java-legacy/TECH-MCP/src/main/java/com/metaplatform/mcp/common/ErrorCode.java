...
public enum ErrorCode {
    ...
    TOOL_CATEGORY_NOT_FOUND(40411, HttpStatus.NOT_FOUND, "工具分类不存在"),
    DEBUG_SESSION_NOT_FOUND(40412, HttpStatus.NOT_FOUND, "调试会话不存在"),
    ALERT_RULE_NOT_FOUND(40413, HttpStatus.NOT_FOUND, "告警规则不存在"),
    EXTERNAL_AGENT_NOT_FOUND(40414, HttpStatus.NOT_FOUND, "外部 Agent 不存在"),
    AGENT_TRUST_NOT_FOUND(40415, HttpStatus.NOT_FOUND, "信任关系不存在"),
    COLLABORATION_NOT_FOUND(40416, HttpStatus.NOT_FOUND, "协作记录不存在"),
    PERMISSION_RULE_NOT_FOUND(40417, HttpStatus.NOT_FOUND, "权限规则不存在"),
    APP_CONFIG_NOT_FOUND(40418, HttpStatus.NOT_FOUND, "应用配置不存在"),
    APP_API_KEY_NOT_FOUND(40419, HttpStatus.NOT_FOUND, "应用 API Key 不存在"),
    APP_NOT_FOUND(40420, HttpStatus.NOT_FOUND, "外部应用不存在"),
    BREAKPOINT_NOT_FOUND(40421, HttpStatus.NOT_FOUND, "调试断点不存在"),
