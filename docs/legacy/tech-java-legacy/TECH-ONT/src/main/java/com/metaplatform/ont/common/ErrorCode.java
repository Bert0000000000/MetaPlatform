...
public enum ErrorCode {
    ...
    CYPHER_WRITE_FORBIDDEN(42208, HttpStatus.UNPROCESSABLE_ENTITY, "Cypher 查询只允许 READ 操作"),
    CYPHER_QUERY_INVALID(42209, HttpStatus.UNPROCESSABLE_ENTITY, "Cypher 查询语句不合法"),
    CYPHER_TEMPLATE_NOT_FOUND(40408, HttpStatus.NOT_FOUND, "Cypher 查询模板不存在"),
    CYPHER_TEMPLATE_ALREADY_EXISTS(40908, HttpStatus.CONFLICT, "Cypher 查询模板已存在"),
