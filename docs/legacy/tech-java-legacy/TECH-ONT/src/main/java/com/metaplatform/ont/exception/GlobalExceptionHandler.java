...
import com.metaplatform.ont.common.TraceContext;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OntException.class)
    public ResponseEntity<ApiResponse<Void>> handleOntException(OntException e) {
