...
```json
{
  ...
  "data": {
    ...
    "linkedValueStreams": [{ "id": "vs-001", "name": "客户获取价值流" }],
    "linkedProcesses": [{ "id": "bp-001", "name": "客户注册流程" }],
    "metadata": {
      "criticality": "HIGH",
...
```json
{
  ...
  "data": {
    ...
    "processType": "PRIMARY",
    "lifecycle": "ACTIVE",
    "linkedCapabilities": [{ "id": "cap-001", "name": "客户管理" }],
    "linkedValueStream": {
      "id": "vs-001",
      "name": "客户获取价值流"
    },
    ...
    "supportingApplications": [{ "id": "app-001", "name": "CRM 系统" }],
    "metadata": {
      "frequency": "高",
      "automationLevel": "半自动"
    },
...
```json
{
  ...
  "data": {
    ...
    "parentId": null,
    "roleType": "DEPARTMENT",
    "ownedCapabilities": [{ "id": "cap-001", "name": "客户管理" }],
    "ownedProcesses": [{ "id": "bp-001", "name": "客户注册流程" }],
    "createdAt": "2026-07-16T08:00:00Z",
    "updatedAt": "2026-07-16T08:00:00Z"
  },
  "traceId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"
    ...
    "items": [
      {
        ...
        "lifecycle": "ACTIVE",
        "techStacks": [{ "id": "ts-001", "name": "Spring Boot 3.4" }],
        "supportingCapabilities": [{ "id": "cap-001", "name": "客户管理" }],
        "ownerRoleId": "org-role-001",
        "criticality": "HIGH",
        "createdAt": "2026-07-16T08:00:00Z",
        "updatedAt": "2026-07-16T08:00:00Z"
...
```json
{
  ...
  "data": {
    ...
    "supportingCapabilities": [{ "id": "cap-001", "name": "客户管理" }],
    "supportingProcesses": [{ "id": "bp-001", "name": "客户注册流程" }],
    "dependencies": {
      "outbound": [
        {
          "id": "dep-001",
...
```json
{
  ...
  "data": {
    ...
    "lifecycle": "PROPOSED",
    "techStacks": [{ "id": "ts-001", "name": "Spring Boot 3.4" }],
    "supportingCapabilities": [{ "id": "cap-003", "name": "供应链管理" }],
    "ownerRoleId": "org-role-005",
    "criticality": "CRITICAL",
    "createdAt": "2026-07-16T11:00:00Z",
    "updatedAt": "2026-07-16T11:00:00Z"
...
```json
{
  ...
  "data": {
    ...
    "flowsAsSource": [
      {
        "id": "df-001",
        "targetEntityId": "de-003",
        "targetEntityName": "客户画像实体",
        "flowType": "ETL"
      }
    ],
    "flowsAsTarget": [],
  ...
  "data": {
    ...
    "fieldMappings": [
      ...
      },
      {
        ...
        "targetField": "first_contact_date",
...
```json
{
  ...
  "data": {
    ...
    "content": "## 1. 代码结构\n...\n## 2. 命名规范\n...",
    "relatedTechStacks": [{ "id": "ts-001", "name": "Spring Boot 3.4" }],
