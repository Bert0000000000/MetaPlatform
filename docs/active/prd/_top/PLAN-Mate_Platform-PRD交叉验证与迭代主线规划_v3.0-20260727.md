# Mate Platform PRD 交叉验证与迭代主线规划 v3.0

> **版本**: v3.0 | **日期**: 2026-07-27
> **替代**: v2.0-20260719
>
> **v2.0 → v3.0 重大变更**：
> 1. **新增「基于前端代码为主」策略**：盘点报告 `REPORT-前端实现与PRD差异盘点_v1.0-20260727.md` 是新一轮迭代的权威依据
> 2. **新增「前后端并行开发」策略**：API 契约先行 + Mock 兜底 + 解耦开发
> 3. **新增 API 契约文档**：`API-CONTRACT-前端接口契约清单_v1.0-20260727.md`（141 端点）
> 4. **新增并行开发规范**：`PLAN-前后端并行开发接口边界_v1.0-20260727.md`
> 5. **8 份主 PRD 全面刷新**（版本 +1）：以独立 APP 为权威，portal 是工作台
> 6. **6 份按钮操作手册升 v1.1**
> 7. **6 份子 PRD/规划文档同步升版**
...
### 0.1 Q1 决策：portal vs 独立 APP 关系

**结论**: **以独立 APP 为主，portal 是工作台**
- 独立 APP（apps/apphub, apps/arch, apps/mcphub, apps/superai, apps/dw 等）是主实现
- portal（apps/portal）是生产环境的统一入口与工作台聚合
- APP-DASHBOARD PRD 范围 = 独立 dashboard app + portal/dashboard + portal/admin

### 0.2 Q2 决策：后端服务拆分

**结论**: **B 合并到现有 TECH 服务**
- 不新增独立服务
- 前端 6 个未登记前缀（apphub/copilot/dashboard/dw/kb/superai）合并到现有 TECH 服务
- 前端代码无需调整，由 TECH-GW 网关按路由表分流

### 0.3 Q3 决策：未实现交互处理

**结论**: **A 标记为「待前端补」，PRD 列入清单并排期**
- 每个主 PRD 新增「待补交互清单」章节
- 按 P0/P1/P2 标注优先级
- 与后端并行补全
...
| # | 文档 | 旧版 | 新版 | 状态 |
|---|---|---|---|---|
| 1 | docs/prd/_top/API-CONTRACT-前端接口契约清单_v1.0-20260727.md | (新增) | v1.0 | ✅ |
| 2 | docs/prd/_top/PLAN-前后端并行开发接口边界_v1.0-20260727.md | (新增) | v1.0 | ✅ |
| 3 | docs/prd/_top/REPORT-前端实现与PRD差异盘点_v1.0-20260727.md | (新增) | v1.0 | ✅ |
| 4 | docs/prd/_top/PLAN-Mate_Platform-PRD交叉验证与迭代主线规划 | v2.0 | v3.0 | ✅ |
| 5 | docs/prd/APP-DASHBOARD/PRD-APP-DASHBOARD-仪表盘 | v2.2 | v2.3 | ✅ |
| 6 | docs/prd/APP-DASHBOARD/PRD-APP-DASHBOARD-后台管理 | v1.0 | v1.1 | ✅ |
| 7 | docs/prd/APP-DASHBOARD/PRD-APP-DASHBOARD-仪表盘-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 8 | docs/prd/APP-APPHUB/PRD-APP-APPHUB-应用中心 | v2.1 | v2.2 | ✅ |
| 9 | docs/prd/APP-APPHUB/PRD-APP-APPHUB-应用中心-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 10 | docs/prd/APP-ARCH/PRD-APP-ARCH-架构中心 | v2.1 | v2.2 | ✅ |
| 11 | docs/prd/APP-DW/PRD-APP-DW-数字员工 | v2.3 | v2.4 | ✅ |
| 12 | docs/prd/APP-DW/PRD-APP-DW-数字员工-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 13 | docs/prd/APP-DW/PRD-APP-DW-业务RAG知识库Agent | v1.0 | v1.1 | ✅ |
| 14 | docs/prd/APP-DW/PRD-APP-DW-页面专属Agent | v1.0 | v1.1 | ✅ |
| 15 | docs/prd/APP-KB/PRD-APP-KB-知识库 | v1.1 | v1.2 | ✅ |
| 16 | docs/prd/APP-KB/PRD-APP-KB-知识库-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 17 | docs/prd/APP-MCPHUB/PRD-APP-MCPHUB-MCP服务中心 | v2.1 | v2.2 | ✅ |
| 18 | docs/prd/APP-MCPHUB/PRD-APP-MCPHUB-MCP服务中心-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 19 | docs/prd/APP-ONTSTUDIO/PRD-APP-ONTSTUDIO-本体论引擎 | v2.1 | v2.2 | ✅ |
| 20 | docs/prd/APP-ONTSTUDIO/PRD-APP-ONTSTUDIO-本体论引擎-按钮操作手册 | v1.0 | v1.1 | ✅ |
| 21 | docs/prd/APP-ONTSTUDIO/PRD-APP-ONTSTUDIO-状态与改进规划 | v2.1 | v2.2 | ✅ |
| 22 | docs/prd/APP-COPILOT/PRD-APP-COPILOT | v2.2 | v2.3 | ✅ |
| 23 | docs/prd/APP-COPILOT/PRD-APP-COPILOT-超级AI对话 | v2.1 | v2.2 | ✅ |
| 24 | docs/prd/APP-COPILOT/PRD-APP-COPILOT-调度与总结 | v1.0 | v1.1 | ✅ |
...
| 模块 | 旧覆盖率 | 新覆盖率 | 提升 |
|---|---|---|---|
| APP-DASHBOARD | 78% | 80% | +2% |
| APP-APPHUB | 87% | 87% | 持平 |
| APP-ARCH | 73% | 73% | 持平 |
| APP-DW | 76% | 76% | 持平 |
| APP-KB | 65% | 70% | +5% |
| APP-MCPHUB | 60% | 60% | 持平 |
| APP-ONTSTUDIO | 78% | 78% | 持平 |
| APP-COPILOT | 61% | 61% | 持平 |

### 三、新增章节统计

| 章节类型 | 数量 | 说明 |
|---|---|---|
| 待补交互清单（P0/P1/P2） | 8 个主 PRD × 3 优先级 | 列出未实现但 PRD 描述的交互 |
| API 接口概要（Q2=B 归属） | 8 个主 PRD | 标注每个端点归属后端服务 |
| 增量更新说明附录 | 20 份文档 | 解释 v_x → v_y 变更 |
...
1. 后端开发按 API-CONTRACT 落地
2. 前端按各 PRD 「待补交互清单」补全
3. 集成联调与契约测试
4. 预发与生产发布
