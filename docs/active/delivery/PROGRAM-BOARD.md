...
| **DATA-D0-D8** | **D0+D1 Accepted** (⏳ D2-D8) | ✓ | partial | 13/13 ✓ | partial | `evidence/DATA-D0-D8-D{0,1}-ACCEPTANCE.md` |
...
9 个核心批次全部 Accepted;TECH-SLICES 8/17 域已接入;DATA-D0-D8 D0 + D1 已落地(D2-D8 在后续子批推进)。
