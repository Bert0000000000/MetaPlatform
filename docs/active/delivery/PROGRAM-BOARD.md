...
> 更新时间：2026-08-03（含 v3.1 增量 sub-batch + P3-W6/W7 wave + PR 治理状态 + K2/K3 APPHUB-RUNTIME-01 收口 + mcp Fix-1/P3-W10 测试闭环 + v3.2 W2/W3 验证闭环 + v3.2-α G6 应用层增强 + D1 staging smoke 独立化 + G6 RLS PgClient 集成 + v3.2-γ Iceberg/Trino sub-chart；G1-G8 全 Accepted + M-v3.2-α + M-v3.2-γ 内容全部闭环）
