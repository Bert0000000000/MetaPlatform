...
$hdr = @{
    ...
    "X-Trace-Id" = "trace-m2v07-embed-2"
    "X-Tenant-Id" = "tenant-m2v07"
}
$body = Get-Content d:\Hermes\Workspace\10_Projects\2026-07-02-MetaPlatform\docs\006-TMP\m2v07_embed_body.json -Raw -Encoding UTF8
